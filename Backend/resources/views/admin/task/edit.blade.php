                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <h3 class="mb-0 ct_fs_22">Edit Task</h3>
                                    <a href="{{url('list-task')}}" > <button class="ct_custom_btn1 mx-auto"> Back to List </button> </a>
                                </div>
                                <form action="{{url('update-task')}}" method="POST" id="editTask" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="name" class="form-control" name="name" placeholder="Task Name" value="{{ old('name', $task->name)}}">
                                                @error('name')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea rows="4" class="form-control ckeditor" name="description" id="description" placeholder="Description">{{ old('description', $task->description)}}</textarea>
                                                @error('description')
                                                    <div class="text text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="address" id="address" placeholder="Address" value="{{ old('address', $task->address)}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="latitude" placeholder="Latitude" value="{{ old('latitude', $task->latitude)}}" id="latitude" readonly>
                                                @error('latitude')
                                                    <div class="text text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="longitude" placeholder="Longitude" value="{{ old('longitude', $task->longitude)}}" id="longitude" readonly>
                                                @error('longitude')
                                                    <div class="text text-danger mt-2">{{ $message }}</div>
                                                @enderror
                                            </div>
