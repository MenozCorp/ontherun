...
<body class="login-area">
    ...
    ********* Page Wrapper Area End ***********
    ...
    <script src="{{asset('public/admin/js/default-assets/setting.js')}}"></script>
    <script src="{{asset('public/admin/js/default-assets/scrool-bar.js')}}"></script>
    <script src="{{asset('public/admin/js/todo-list.js')}}"></script>

    <!-- Active JS -->
    <script src="{{asset('public/admin/js/default-assets/active.js')}}"></script>
